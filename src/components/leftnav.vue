  ...
  created() {
    ...
    let res = {
      ...
      data: [
        {
          menuid: 1,
          icon: 'iconfont icon-hangbanguanli',
          menuname: '航班管理',
          hasThird: null,
          url: null,
          menus: [
            {
              menuid: 2,
              icon: 'iconfont icon-hangbandongtai',
              menuname: '航班信息',
              hasThird: 'N',
              url: 'goods/Goods',
              menus: null
        ...
        {
          menuid: 150,
          icon: 'iconfont icon-tubiao-bingtu',
          menuname: '图表',
          hasThird: null,
          url: null,
          menus: [
